      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="bg-card/30 backdrop-blur-sm p-8 rounded-xl border border-border/30 hover:border-primary/30 transition-all shadow-lg flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold mb-4">Beratung</h3>
            ...
            <div className="bg-card/30 backdrop-blur-sm p-8 rounded-xl border border-border/30 hover:border-primary/30 transition-all shadow-lg flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold mb-4">Sicherheit</h3>
              <p className="text-white/80">
