        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#solutions" className="hover:text-primary transition-colors">Lösungen</Link></li>
              <li><Link href="#references" className="hover:text-primary transition-colors">Referenzen</Link></li>
              <li><Link href="#contact" className="hover:text-primary transition-colors">Kontakt</Link></li>
            </ul>
          </div>
          
          <div className="space-y-4">
            <h4 className="font-medium">Lösungen</h4>
            <ul className="space-y-2">
              <li><Link href="#solutions" className="hover:text-primary transition-colors">AI-gestützte SaaS</Link></li>
              <li><Link href="#solutions" className="hover:text-primary transition-colors">IT-Dienstleistungen</Link></li>
              <li><Link href="#solutions" className="hover:text-primary transition-colors">MVP-Entwicklung</Link></li>
              <li><Link href="#solutions" className="hover:text-primary transition-colors">Cloud Management</Link></li>
            </ul>
          </div>
          
          <div className="space-y-4">
            <h4 className="font-medium">Rechtliches</h4>
            <ul className="space-y-2">
